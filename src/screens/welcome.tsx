      ...
      <div className="flex flex-col items-center justify-center max-w-xl text-justify">
        ...
        <div className="p-4 bg-gray-100 dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 w-full">
          <div className="flex flex-wrap gap-3 justify-center">
            ...
            <Button.One href={config.links.demo}>
              {t("screens.welcome.links.demo")}
            </Button.One>
            <Button.One href={config.links.github.contributing}>
              {t("screens.welcome.links.contribute")}
            </Button.One>
            <Button.One href={config.links.github.authors}>
              {t("screens.welcome.links.author")}
            </Button.One>
            <Button.One href={config.links.github.license}>
